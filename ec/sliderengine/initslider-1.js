jQuery(document).ready(function () {
  ...
  jQuery(".amazingslider-1").amazingslider({
    ...
    watermarkimage: "",
    watermarktextcss:
      "font:12px Arial,Tahoma,Helvetica,sans-serif;color:#333;padding:2px 4px;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;background-color:#fff;opacity:0.9;filter:alpha(opacity=90);",
    ...
    descriptioncss:
      'display:block; position:relative; font:12px "Lucida Sans Unicode","Lucida Grande",sans-serif,Arial; color:#fff;  background-color:#021b38; margin-top:10px; padding:10px; ',
    ...
    titlecss:
      "display:table; position:relative; font:24px Georgia,serif,Arial; color:white; white-space:nowrap;",
    ribbonimagey: 0,
    ribbonimagex: 0,
